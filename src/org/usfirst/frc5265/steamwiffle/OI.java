...
public class OI {
    ...
    public JoystickButton blinkerButton;
    public JoystickButton lights;
    public JoystickButton toggleTest;
    ...
    public OI() {
        ...
        blinkerButton = new JoystickButton(steering, 2);
         	blinkerButton.whenPressed(new newLightButton());
        toggleTest = new JoystickButton(steering, 4);
        	toggleTest.whenPressed(new toggleTest());
        	SmartDashboard.putNumber("toggleTest", 0);
