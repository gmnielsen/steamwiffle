...
public class stagValues extends Subsystem {
	...
	public static final double laa01dx = 0.0, laa01dy = 0.0, laa01dt = 0.0, laa01dtime = 1.0;
	public static final double laa02dx = 0.0, laa02dy = 0.5, laa02dt = 0.09, laa02dtime = 1.0;
