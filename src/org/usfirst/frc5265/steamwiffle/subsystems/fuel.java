...
public class fuel extends Subsystem {
    ...
    private final DigitalInput limitSwitch1 = RobotMap.fuelLimitSwitch1;

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS
    
    public void shoot(double power) {
    	//power = SmartDashboard.getNumber("shooterValue");    	
    	
    	SmartDashboard.putNumber("shooter motor", power);
    ...
    public void initDefaultCommand() {
    	...
    	setDefaultCommand(new ShootByTime(0, 0));
